  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-primary-50 font-poppins">
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link href="/features" className="text-neutral-600 hover:text-[#0D9488] font-medium">
              Features
            </Link>
            <Link href="/about" className="text-neutral-600 hover:text-[#0D9488] font-medium">
              About
            </Link>
            <Link href="/contact" className="text-neutral-600 hover:text-[#0D9488] font-medium">
              Contact
            </Link>
            <Button asChild>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-6 bg-[rgba(13,148,136,0.1)] text-[#0D9488] font-grotesk font-medium">Student Engagement Platform</Badge>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#0D9488] to-[#0F766E] rounded-3xl p-8 text-white text-center">
                ...
                <Button size="lg" variant="secondary" className="bg-white text-[#0D9488] hover:bg-gray-100">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-[rgba(13,148,136,0.1)] text-[#0D9488] font-grotesk font-medium">Platform Features</Badge>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-[rgba(13,148,136,0.1)] text-[#0D9488] font-grotesk font-medium">Student Success Stories</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-neutral-900 mb-6 font-grotesk">
              Loved by{" "}
              <span className="bg-gradient-to-r from-[#0D9488] to-[#0F766E] bg-clip-text text-transparent">
                Students
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="border-2 border-[#0D9488]/20 bg-gradient-to-r from-[#0D9488] to-[#0F766E] text-white rounded-3xl">
            <CardContent className="p-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#0D9488] font-grotesk font-medium" asChild>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-neutral-600 font-poppins">
                <li>
                  <Link href="/features" className="hover:text-[#0D9488]">Features</Link>
                </li>
                <li>
                  <Link href="/about" className="hover:text-[#0D9488]">About Us</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-neutral-600 font-poppins">
                <li>
                  <Link href="/help" className="hover:text-[#0D9488]">Help Center</Link>
                </li>
                <li>
                  <Link href="/privacy" className="hover:text-[#0D9488]">Privacy Policy</Link>
                </li>
                <li>
                  <Link href="/terms" className="hover:text-[#0D9488]">Terms of Service</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <div className="flex space-x-4">
                <Link href="#" className="text-neutral-600 hover:text-[#0D9488]">
